...
const WalletAnalysisDashboard = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Wallet Analysis</h1>
        <p className="text-muted-foreground">
          Comprehensive risk analysis and AML compliance checking for wallet addresses across multiple blockchains.
        </p>
      </div>
