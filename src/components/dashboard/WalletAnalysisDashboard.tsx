...
const WalletAnalysisDashboard = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Wallet Analysis</h2>
        <p className="text-gray-600">
          Perform comprehensive AML compliance analysis for any wallet address across multiple blockchains.
        </p>
      </div>
